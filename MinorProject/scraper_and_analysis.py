...
def scrape_and_analyze():
    ...
    version = 'text classifier ™ 1.2'

    options = ['Start', 'Developer Page', 'Exit']

    button = g.buttonbox(
        'Welcome to text classifier ™ Twitter Scraper and Seniment Analyzer Version 1.2' +
        '\n' + '\n' + '\n' + '\n' + '\n' +
        'Created by Ishmeet Singh, Copyright 2018 Licensed Under MIT License',
    ...
    if button == options[0]:
        pass
    if button == options[1]:
        webbrowser.open('https://github.com/bigmanstan', new=0, autoraise=True)
    if button == options[2]:
        sys.exit()
